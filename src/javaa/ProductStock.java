...
public class ProductStock {
    ...
    private int onHand;            // physical units stored الكمية الحالية في المخزن
    private int reserved;          // units reserved for orders
    private int reorderThreshold;  // when available < threshold → reorder needed الكملة الي اذا صارت في المخزن لازم اطلب طلبية جديدة
    private int maxCapacity;       // max units this location can store

    /**
     * Creates a java.ProductStock instance with basic inventory info.
     *
